-- From https://github.com/victorso/.hammerspoon
...
local label_length = 400 -- How wide (in characters) the dropdown menu should be. Copies larger than this will have their label truncated and end with "…" (unicode for elipsis ...)
...
selectorobj = hs.chooser.new(putOnPaste)
selectorobj:choices(populateChooser)
